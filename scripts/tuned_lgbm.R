...
lgbm_model <- boost_tree(
  ...
  set_engine("lightgbm") |> #objective='count:poisson'
  set_mode("regression")
...
write_rds(best_model, "data/best_model_params.RDS")
best_model <- read_rds("data/best_model_params.RDS")
...
write_csv(forecast, "data/tuned_lgbm.csv")
